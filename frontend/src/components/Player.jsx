...
const Player = ({ scenes }) => {
    ...
    const slideSrc = currentScene?.slide_url ? `${ASSET_BASE}/${currentScene.slide_url.replace(/^\/+/, '')}` : null;
    const audioSrc = currentScene?.audio_url ? `${ASSET_BASE}/${currentScene.audio_url.replace(/^\/+/, '')}` : null;
