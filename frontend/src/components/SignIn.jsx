...
const SignIn = () => {
    ...
    const handleEmailSubmit = async (e) => {
        ...
        try {
            ...
            setIsLoading(false);
            setError(err?.response?.data?.detail || err?.response?.data?.message || 'Sign in failed');
            triggerShake();
        }
    };
        ...
        <div style={{
            ...
            >
                ...
                <div style={{
                    ...
                    {/* Card content */}
                    <div style={{ position: 'relative', zIndex: 1, padding: '2rem 2rem' }}>
                        ...
                        <motion.p
                            ...
                            style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.9rem', marginBottom: '1.5rem' }}
                        >
                        ...
                        <form onSubmit={handleEmailSubmit}>
                            ...
                            {/* Primary CTA — matches Show.jsx "Start Class" button style */}
                            <motion.div custom={5} variants={itemVariants} initial="hidden" animate="visible">
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        borderRadius: '50px',        /* pill — same as Show.jsx "Start Class" */
                                        color: '#fff',
                                        fontWeight: '700',
                                        fontSize: '0.95rem',
                        ...
                        {/* ── Footer ── */}
                        <motion.div
                            custom={8} variants={itemVariants} initial="hidden" animate="visible"
                            style={{
                                marginTop: '1.25rem',
                                textAlign: 'center',
                                fontSize: '0.85rem',
